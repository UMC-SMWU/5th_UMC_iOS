...
class RegisterViewController: UIViewController {
    ...
    // 유효성 검사를 위한 property
    // 각 textfield가 변화될 때마다 유효성 검사가 실행됨
    var isValidEmail = false {
        didSet { //property observer. setting 후에 아래 코드를 실행
    ...
    // 코드를 깔끔하게 하기 위해 연산 property 활용(반복적으로 들어가는 것들에 활용)
    ...
    // 사용자가 입력한 회원 정보를 확인하고 이를 바탕으로 UI를 업데이트함(signupButton의 배경색을 변경)
